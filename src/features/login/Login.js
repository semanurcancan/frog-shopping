        ...
        <div className='allpage '>
            <div className='login '>
                <div className='flex flex-col justify-center bg-green-100'>
                    ...
                    <ul>
                        <li><input placeholder='Full Name(test)' className='text-sm focus: outline-none focus:outline-gray-200' type="text" onKeyDown={handleKeyDown} ref={name} /></li>
                        <li><input placeholder='Password(test)' className='text-sm focus: outline-none focus:outline-gray-200' type="password" onKeyDown={handleKeyDown} ref={password} /></li>
                        <br></br>
